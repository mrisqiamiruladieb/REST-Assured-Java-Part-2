...
public class deleteUser {
    ...
    @Test
    public void validateDeleteUserWithNonIntegerId() {

        // Save path file bad request delete user by id response schema

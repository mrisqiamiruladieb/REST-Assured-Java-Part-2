...
public class getUserById {
    ...
    @Test
    public void validateGetDataWithNonIntegerId() {

        // Save path file bad request get user by id response schema
        ...
        response.then()
                ...
                .body("errors.id[0]", equalTo("The value 'hello_world' is not valid."))
                .body(JsonSchemaValidator.matchesJsonSchema(new File(jsonSchemaFilePath))) // Validate the json schema response
                .time(lessThan(5000L)); // Validate the response time – in milliseconds
    }

    @Test
    public void validateGetUserDataWithBlankId() {
